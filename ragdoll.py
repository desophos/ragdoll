...
from globals import SCREEN_SIZE, FPS, STEP_TIME, CROSSHAIRS_SIZE, WALL_WIDTH, \
    COLLISION_GROUP, COLLISION_TYPE, PLAYER_MOVEMENT_SPEED, PLAYER_ID, BULLET_PRUNING_VELOCITY, CHARACTER_ANGULAR_VELOCITY_LIMIT
from utility import *
...
character_index = PLAYER_ID # used for keeping track of number of characters; the player is the first character defined

me = Character(gun_type="shotgun", cid=character_index)
space.add_character(me)
character_index += 1
me_sprite = pygame.sprite.RenderPlain(me, me.gun) # create sprite group for the player
...
walls = [pymunk.Segment(space.static_body, (0,WALL_WIDTH/2), (SCREEN_SIZE, WALL_WIDTH/2), WALL_WIDTH), # bottom
